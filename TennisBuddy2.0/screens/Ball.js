        ...
        {menuOpen && (
            <Animated.View style={[styles.fullScreenMenu, { transform: [{ translateX: slideAnim }] }]}>
                ...
                <View style={{marginBottom:40, flexDirection:'row', height:'3%', alignItems:'center'}}>
                    <View style={{backgroundColor:'white' , marginRight:20, height:'70%', width:'15%', borderRadius:100, alignItems:'center', justifyContent:'center'}}><Text style={{fontSize:25, fontWeight:'bold'}}>A</Text></View>
