...
export default function Shop (){
    ...
    return (
      <View>
        ...
        <View  style={styles.line}>
            <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.line1}>
                <View style={styles.unit}>
                    ...
                    <Image
                        source={require('./assets/wilson_logo.jpg')}
                        style={{
                ...
                <View style={styles.unit}>
                    <TouchableOpacity style={styles.line2_gauche} onPress={''}>
                        <Image
                            source={require('./assets/ke_logo.jpg')}
                            style={{
                                width: 50,     // Set the width you want
                                height: 50,    // Set the height you want
                                resizeMode: 'contain', 
                ...
                <View style={styles.unit}>
                    ...
                    <Image
                        source={require('./assets/uniqlo_logo.jpg')}
                        style={{
                            width: 45,     // Set the width you want
                            height: 45,    // Set the height you want
                            resizeMode: 'contain', 
                            borderRadius:5
                        }}
                    />
                ...
                <View style={styles.unit}>
                    ...
                    <Image
                        source={require('./assets/head_logo.jpg')}
                        style={{
                            width: 50,     // Set the width you want
                ...
                <View style={styles.unit}>
                    <TouchableOpacity style={styles.line2} onPress={''}>
                    <Image
                        source={require('./assets/asics_logo.jpg')}
                        style={{
                            width: 50,     // Set the width you want
                            height: 50,    // Set the height you want
                            resizeMode: 'contain', 
                ...
                <View style={styles.unit}>
                    <TouchableOpacity style={styles.line2_droite} onPress={''}>
                    <Image
                        source={require('./assets/yonex_logo.jpg')}
                        style={{
                            width: 65,     // Set the width you want
                ...
                <View style={styles.unit}>
                    <TouchableOpacity style={styles.line2_droite} onPress={''}>
                    <Image
                        source={require('./assets/babolat_logo.jpg')}
                        style={{
        ...
        <Text style={{marginTop:0, marginLeft:10, fontSize:25,alignSelf:'center', fontWeight:'bold' }}> OR Shop by Item</Text>

        <View style={{alignSelf:'center', height:'51%' , width:'100%', flexDirection:'row', justifyContent:'center', marginTop:30}}>
            <View style={{flexDirection:'column', marginRight:12, width:'40%'}}>
                <TouchableOpacity style={styles.shop_item}>
                    <MaterialIcons name="sports-tennis" size={40} color="black" />
                    <Text style={styles.item}>Racquets</Text>
                </TouchableOpacity>
                <TouchableOpacity style={styles.shop_item}>
                    <MaterialCommunityIcons name="shoe-sneaker" size={40} color="black" />
                    <Text style={styles.item}>Tennis shoes</Text>
                </TouchableOpacity>
                <TouchableOpacity style={styles.shop_item}>
            ...
            <View style={{flexDirection:'column' , width:'40%'}}>
                <TouchableOpacity style={styles.shop_item}>
                    <Ionicons name="tennisball" size={40} color="black" />  
                    <Text style={styles.item}>Balls</Text>
                </TouchableOpacity>
                <TouchableOpacity style={styles.shop_item}>
                    <FontAwesome5 name="tshirt" size={32} color="black" />
                    <Text style={styles.item}>Shirts</Text>
                </TouchableOpacity>
                <TouchableOpacity style={styles.shop_item}>
                    <MaterialIcons name="play-lesson" size={40} color="black" />
                    <Text style={styles.item}>Lessons</Text>
